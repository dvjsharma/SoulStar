...
export function FeatureCard({
  ...
  return (
    <motion.div
      ...
      className="p-6 rounded-lg bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-colors relative group"
    >
      ...
      <Icon className="w-10 h-10 text-white mb-4 relative z-10" />
